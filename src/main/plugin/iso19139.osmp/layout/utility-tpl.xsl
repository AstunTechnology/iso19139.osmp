...
<xsl:import href="../../iso19139/layout/utility-tpl.xsl"/>
 ...
 <xsl:template name="get-iso19139.osmp-title">
    <xsl:call-template name="get-iso19139-title"/>
  </xsl:template>

	<xsl:template name="get-iso19139.osmp-is-service">
		<xsl:call-template name="get-iso19139-is-service"/>
	</xsl:template>

	<xsl:template name="get-iso19139.osmp-extents-as-json">
		<xsl:call-template name="get-iso19139-extents-as-json"/>
	</xsl:template>

  <xsl:template name="get-iso19139.osmp-online-source-config">
