...
<xsl:template mode="mode-iso19139" priority="5000" match="gmd:metadataStandardName[$schema='iso19139.osmp']|gmd:metadataStandardVersion[$schema='iso19139.osmp']">
  ...
  <xsl:template mode="mode-iso19139" priority="500" match="*[*/@codeList and $schema='iso19139.osmp']">
    <xsl:param name="schema" select="$schema" required="no"/>
    <xsl:param name="labels" select="$labels" required="no"/>
  ...
  <xsl:template mode="mode-iso19139" priority="200" match="gmd:otherConstraints[$schema='iso19139.osmp' and gmx:Anchor]">
  ...
  -->
  <xsl:template mode="mode-iso19139" match="gml:beginPosition[$schema='iso19139.osmp']|gml:endPosition[$schema='iso19139.osmp']|gml:timePosition[$schema='iso19139.osmp']"
                priority="5000">
 ...
 -->
  <xsl:template mode="mode-iso19139" match="gml:duration[$schema='iso19139.osmp']" priority="200">
  ...
  <xsl:template mode="mode-iso19139"
                match="gmd:topicCategory[position() =1 and $schema='iso19139.osmp']"
                priority="2200">
  ...
  <!-- Service type boxed -->
  <xsl:template mode="mode-iso19139"
                match="srv:serviceType[$schema='iso19139.osmp']"
                priority="2200">
  ...
  <xsl:template mode="mode-iso19139"
                match="gmd:spatialRepresentationType[$schema='iso19139.osmp']"
                priority="2200">
 ...
 <xsl:template mode="mode-iso19139"
               match="gmd:verticalCRS[(count(gml:*) = 0) and $schema='iso19139.osmp']"
               priority="2200">
